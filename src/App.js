...
class App extends Component {
  ...
  getAllMovies = () => {
    axios
      .get('https://quiet-harbor-19037.herokuapp.com/getallmovies')
      .then(result => {
  ...
  onSubmit = e => {
    ...
    const query = `https://quiet-harbor-19037.herokuapp.com/getmovie?title=${
      this.state.title
    }`;
  ...
  removeMovie(title) {
    ...
    const query = `https://quiet-harbor-19037.herokuapp.com/deletemovie?title=${title}`;
    axios
      .get(query)
      .then(result => {
        this.getAllMovies();
